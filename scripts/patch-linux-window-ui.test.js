...
test("Computer Use availability descriptor matches the current settings bundle name", () => {
  ...
  assert.match("computer-use-settings-BzkBOuLk.js", descriptor.pattern);
...
test("enables a minified React-compiled Computer Use settings card contract on Linux", () => {
  const source =
    "var fn=`computer-use`;function Ht(){let e=cache(24),{selectedHostId:t}=host(),i={hostId:t};" +
