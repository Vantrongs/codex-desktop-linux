...
function syntheticMainBundle() {
  return [
    ...
    'function wV({resourcesPath:e}){return new class{resourcesPath=e;addon=null;getAddon(){if(this.resourcesPath==null)throw Error(`Remote control device keys require resourcesPath`);return this.addon??=bV((0,i.join)(this.resourcesPath,`native`,xV)),this.addon}createDeviceKey(e){return this.getAddon().createDeviceKey(e??`hardware_only`)}deleteDeviceKey(e){return this.getAddon().deleteDeviceKey(e)}getDeviceKeyPublic(e){return this.getAddon().getDeviceKeyPublic(e)}async signDeviceKey(e,t){let r=TV(t);return{...await this.getAddon().signDeviceKey(e,r),signedPayloadBase64:r.toString(`base64`)}}}}',
...
function syntheticCurrentMainBundle() {
  return [
    ...
    'function pz({resourcesPath:e}){return new class{resourcesPath=e;addon=null;getAddon(){if(this.resourcesPath==null)throw Error(`Remote control device keys require resourcesPath`);return this.addon??=lz((0,i.join)(this.resourcesPath,`native`,uz)),this.addon}createDeviceKey(e){return this.getAddon().createDeviceKey(e??`hardware_only`)}deleteDeviceKey(e){return this.getAddon().deleteDeviceKey(e)}getDeviceKeyPublic(e){return this.getAddon().getDeviceKeyPublic(e)}async signDeviceKey(e,t){let r=mz(t);return{...await this.getAddon().signDeviceKey(e,r),signedPayloadBase64:r.toString(`base64`)}}}}',
