...
- Starts the Desktop-owned app-server or declarative-owner proxy with
...
| `linux-remote-mobile-app-server-remote-control` | `mobile-host` | Starts a native Desktop-owned app-server or proxies Desktop RPCs to a declarative owner, with focused Remote transport lifecycle logging. |
